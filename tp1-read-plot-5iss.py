...
def plot3d(filename):
    ...
    print("---------------------------------------")
    print("Affichage données 3d : " + filename)
...
# - pour t1=t[:,0] --> [1, 3, 5, 7]
# - pour t2=t[:,1] --> [2, 4, 6, 8]
filename = "spiral.arff"
plot2d(filename)
#plot2d(filename, True)
clusterKMeans(filename, 4, True)
evaluateKMeansElbow(filename, 10, True)
evaluateKMeansSilhouette(filename, 10, True)
